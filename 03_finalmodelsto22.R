...
ggsave("allYear22/BaseModelOutputNumber.jpeg", units = "mm", height = 200, width = 400)
...
ggsave("allYear22/BaseModelOutputNumberNoYear.jpeg", units = "mm", height = 200, width = 400)
...
ggsave("allYear22/SPDEModelOutputNumber.jpeg", units = "mm", height = 200, width = 400)
...
ggsave("allYear22/SPDEModelOutputNumberNoYear.jpeg", units = "mm", height = 200, width = 400)
...
ggsave("allYear22/FemaleModelOutputNumber.jpeg", units = "mm", height = 200, width = 400)
...
ggsave("allYear22/MaleModelOutputNumber.jpeg", units = "mm", height = 200, width = 400)
...
ggsave("allYear22/FemaleMap.jpeg", units = "mm", height = 200, width = 300)
...
ggsave("allYear22/MaleMap.jpeg", units = "mm", height = 200, width = 500)
...
IMListNum %>% 
  ...
  saveRDS("allYear22/NumberModelOutputs.rds")
...
IMListNum %>% 
  ...
  saveRDS("allYear22/NumberModelOutputsSPDE.rds")
...
ggsave("allYear22/BaseModelForceProp.jpeg", plot = summary.prop, units = "mm", height = 200, width = 400)
ggsave("allYear22/SPDEModelForceProp.jpeg", plot = summary.prop.spatial, units = "mm", height = 200, width = 400)
...
female.clutch.prop %>% 
  ...
  saveRDS("allYear22/female.clutch.prop.rds")
...
female.clutch.prop %>% 
  ...
  saveRDS("allYear22/female.clutch.propSPDE.rds")
...
female.lay.prop %>% 
  ...
  saveRDS("allYear22/female.lay.prop.rds")
...
female.lay.prop %>% 
  ...
  saveRDS("allYear22/female.lay.propSPDE.rds")
...
male.clutch.prop %>% 
  ...
  saveRDS("allYear22/male.clutch.prop.rds")
...
male.clutch.prop %>% 
  ...
  saveRDS("allYear22/male.clutch.propSPDE.rds")



####supplementary only inds with at least 3 neighbors of each sex identified####

DFsupp <- readRDS("Data/fn.data.full.ALLYEARSto22.Rds")
...
ggsave("allYear22/BaseModelOutputNumber.suppid.jpeg", units = "mm", height = 200, width = 400)
...
ggsave("allYear22/SPDEModelOutputNumber.suppid.jpeg", units = "mm", height = 200, width = 400)
...
IMListID %>% 
  ...
  saveRDS("allYear22/SuppIDModelOutputs.rds")
...
IMListID %>% 
  ...
  saveRDS("allYear22/SuppIDModelOutputsSPDE.rds")
...
ggsave("allYear22/BaseModelOutputAge.jpeg", units = "mm", height = 200, width = 400)
...
ggsave("allYear22/SPDEModelOutputAge.jpeg", units = "mm", height = 200, width = 400)
...
IMListAge %>% 
  ...
  saveRDS("allYear22/AgeModelOutputs.rds")
...
IMListAge %>% 
  ...
  saveRDS("allYear22/AgeModelOutputsSPDE.rds")
...
ggsave("allYear22/IDMap.jpeg", units = "mm", height = 200, width = 500)
